    ...
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-3xl font-bold text-center mb-8">Upload Resume</h1>
          ...
          {result && (
            <div className="mt-10">
              ...
              <div className="bg-white border rounded-xl p-5 mb-6">
                <h2 className="text-xl font-bold mb-3">Resume Details</h2>

                <p>
                  <strong>Filename:</strong> {result.resume.filename}
                </p>

                <p className="mt-2">
                  <strong>Uploaded:</strong>{" "}
                  {new Date(result.resume.uploadedAt).toLocaleString()}
                </p>
              </div>
