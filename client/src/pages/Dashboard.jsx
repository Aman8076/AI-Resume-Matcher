  ...
  const fetchDashboard = async () => {
    try {
      ...
      if (resumeList.length > 0) {
        average =
          resumeList.reduce((sum, item) => sum + item.atsScore, 0) /
          resumeList.length;
      }
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <p className="text-5xl font-bold mt-3">{stats.totalResumes}</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-gray-500">Job Matches</h2>
      ...
      {stats.latestResume && (
        <div className="bg-white rounded-xl shadow-lg p-6 mt-10">
          ...
          <p>
            <strong>Filename:</strong> {stats.latestResume.filename}
          </p>

          <p className="mt-2">
            <strong>ATS Score:</strong> {stats.latestResume.atsScore}/100
          </p>
