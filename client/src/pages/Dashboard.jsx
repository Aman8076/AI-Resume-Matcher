  ...
  const fetchDashboard = async () => {
    try {
      ...
      setStats({
        ...
        totalApplications: applicationRes.data.totalApplications,
      ...
      <div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <h2 className="text-5xl font-bold mt-3">{stats.totalResumes}</h2>
          </div>

          <div className="bg-white rounded-xl shadow-lg p-6">
            <p className="text-gray-500">Average ATS</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="mb-3">
              Total Resume :<strong> {stats.totalResumes}</strong>
            </p>

            <p className="mb-3">
              Average ATS :<strong> {stats.averageATS}</strong>
            </p>

            <p className="mb-3">
              Job Matches :<strong> {stats.totalMatches}</strong>
            </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mt-10">
          <h2 className="text-2xl font-bold mb-5">ATS Score History</h2>
        ...
        {stats.latestResume && (
          <div className="bg-white rounded-xl shadow-lg p-6 mt-10">
            <h2 className="text-2xl font-bold mb-5">Latest Resume</h2>

            <p>
              <strong>File :</strong> {stats.latestResume.filename}
            </p>

            <p className="mt-2">
              <strong>ATS :</strong> {stats.latestResume.atsScore}/100
            </p>

            <p className="mt-2">
              <strong>Uploaded :</strong>{" "}
              {new Date(stats.latestResume.uploadedAt).toLocaleString()}
            </p>
          </div>
        )}
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mt-10">
          ...
          {resumes.length === 0 ? (
            ...
            resumes.slice(0, 5).map((resume) => (
              <div key={resume._id} className="border-b py-3">
